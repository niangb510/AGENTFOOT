/* ==========================================
   MODULE PARTAGÉ : GESTION DES ACTUALITÉS
   ========================================== */
...
(function () {
    ...
    const defaultBackupArticles = [
        {
            ...
            "images": ["assets/images/cyriaque.webp"],
    ...
    function getRelatedArticles(articles, currentArticle, count) {
        let related = articles.filter(a => a.id !== currentArticle.id && a.category === currentArticle.category);
        if (related.length < count) {
            related = [...related, ...articles.filter(a => a.id !== currentArticle.id && !related.find(r => r.id === a.id))];
        }
